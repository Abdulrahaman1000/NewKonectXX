  ...
  return (
    <section className="relative overflow-hidden min-h-[96vh] flex items-center">
      {slides.map((slide, i) => (
        ...
        >
          ...
          >
            ...
            <div
              className="absolute inset-0"
              style={{ background: 'linear-gradient(to right, transparent 15%, rgba(6,6,20,0.6) 100%)' }}
            />
          </div>
      ...
      <div className="absolute top-8 right-16 z-20">
        <span
          className="text-[10px] tracking-[0.22em] uppercase font-bold px-4 py-2 rounded-full backdrop-blur-md border border-primary/25 text-primary/85"
      ...
      <div className="container-premium section-padding py-32 relative z-10 w-full">
        <div className="max-w-[560px] space-y-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] tracking-[0.28em] uppercase font-bold text-primary/80">
              Limited Time Offer
            </span>
          </div>
          <h1
            className="text-5xl md:text-[4.5rem] font-black leading-[1.03] tracking-tight text-white"
          ...
          {featuredCombo && (
            <>
              <p className="text-[15px] text-white/60 leading-relaxed max-w-[420px]">
                {featuredCombo.items.map((i) => i.name).join(' · ')} —<br />
                {featuredCombo.items.length} premium pieces, one unbeatable promo price.
              </p>
              <div className="flex items-center gap-4 pt-1">
                <span className="text-[2.8rem] md:text-5xl font-black text-primary leading-none">
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2 text-[12px] text-white/45 pt-1">
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  Only {featuredCombo.stockLeft} units left
                </span>
              </div>
            </>
          )}
